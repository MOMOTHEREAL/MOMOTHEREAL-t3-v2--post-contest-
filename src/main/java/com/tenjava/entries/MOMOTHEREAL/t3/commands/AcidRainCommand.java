...
public class AcidRainCommand implements CommandExecutor{
    ...
    public AcidRainCommand(TenJava plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender commandSender, Command cmd, String label, String[] args) {
        ...
        if (!player.hasPermission("acidic.acidrain")) {
        ...
        weather.startAcidRain();
        messageUtil.sendMessage("§3Started acid rain in all worlds.", player, true);
